<?php
/**
 * Top ten movie searches Bar Chart Generator
 *
 * PHP version 5
 *
 * @file 
...
imagestring($image, 31, 220, 20, 'Top 10 Movies Searches', $black);
imagestring($image, 31, $gridLeft+5, 70, 'Movies', $black);
imagestring($image, 31, $gridRight+5, $gridBottom, 'Searches', $black);
